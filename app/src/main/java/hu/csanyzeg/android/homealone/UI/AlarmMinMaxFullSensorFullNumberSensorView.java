 ...
 */
public class AlarmMinMaxFullSensorFullNumberSensorView extends AlarmFullNumberSensorView {
    ...
    public AlarmMinMaxFullSensorFullNumberSensorView(Context context) {
        super(context);
    }

    public AlarmMinMaxFullSensorFullNumberSensorView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AlarmMinMaxFullSensorFullNumberSensorView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    @Override
    public void inflate() {
        LayoutInflater.from(getContext()).inflate(hu.csanyzeg.android.homealone.R.layout.alarm_min_max_full_number_sensor_view, this);
    }
