...
public class InputNumberSensorView extends GraphNumberSensorView {

    private OnValueChangedListener onValueChangedListener = null;
    private EditValueView inputValueView;

    public InputNumberSensorView(Context context) {
        super(context);
    }

    public InputNumberSensorView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public InputNumberSensorView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    @Override
    public void inflate() {
        LayoutInflater.from(getContext()).inflate(R.layout.input_number_sensor_view, this);
    }
