...
public class AlarmFullNumberSensorView extends FullNumberSensorView implements Alarm {
    ...
    public AlarmFullNumberSensorView(Context context) {
        super(context);
    }

    public AlarmFullNumberSensorView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AlarmFullNumberSensorView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setAlarm(boolean alarm) {
        this.alarm = alarm;
        getGraphNumberSensorView().getValueView().setAlarm(alarm);
    }
