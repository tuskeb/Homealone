...
public class AlarmFullBoolSensorView extends FullBoolSensorView implements Alarm {
...
*/
    public AlarmFullBoolSensorView(Context context) {
        super(context);
    }

    public AlarmFullBoolSensorView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public AlarmFullBoolSensorView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    @Override
    public void inflate() {
        LayoutInflater.from(getContext()).inflate(R.layout.alarm_full_bool_sensor_view, this);
    }
...
*/
    ...
    public void setAlarm(boolean alarm) {
        this.alarm = alarm;
        getGraphBoolSensorView().getValueView().setAlarm(alarm);
    }
